...
const FORMATIONS = {
  "4-4-2": {
    ...
    coords: [
      { x: 8, y: 50 }, { x: 20, y: 15 }, { x: 20, y: 35 }, { x: 20, y: 65 }, { x: 20, y: 85 },
      { x: 35, y: 15 }, { x: 35, y: 38 }, { x: 35, y: 62 }, { x: 35, y: 85 },
      { x: 48, y: 35 }, { x: 48, y: 65 }
    ]
  },
  "4-3-3": {
    ...
    coords: [
      ...
      { x: 32, y: 50 }, { x: 38, y: 30 }, { x: 38, y: 70 },
      { x: 46, y: 15 }, { x: 48, y: 50 }, { x: 46, y: 85 }
    ]
  },
  "3-5-2": {
    labels: ["GK", "CB", "CB", "CB", "LWB", "CM", "CM", "CM", "RWB", "ST", "ST"],
    coords: [
      { x: 8, y: 50 }, { x: 20, y: 30 }, { x: 20, y: 50 }, { x: 20, y: 70 },
      { x: 30, y: 10 }, { x: 34, y: 35 }, { x: 34, y: 50 }, { x: 34, y: 65 }, { x: 30, y: 90 },
      { x: 48, y: 35 }, { x: 48, y: 65 }
    ]
  },
  "4-2-3-1": {
    ...
    coords: [
      { x: 8, y: 50 }, { x: 20, y: 15 }, { x: 20, y: 38 }, { x: 20, y: 62 }, { x: 20, y: 85 },
      { x: 30, y: 35 }, { x: 30, y: 65 },
      { x: 40, y: 20 }, { x: 40, y: 50 }, { x: 40, y: 80 }, { x: 48, y: 50 }
    ]
  },
  // Add more formations as needed following the exact same 11-element pattern
};
...
function MatchLineup({ 
  ...
  const getSlotPosition = (pos, team) => {
    if (!isVertical) {
      return { left: `${team === "A" ? pos.x : 100 - pos.x}%`, top: `${pos.y}%` };
    } else {
      return { left: `${team === "A" ? pos.y : 100 - pos.y}%`, top: `${100 - pos.x}%` };
    }
  };
